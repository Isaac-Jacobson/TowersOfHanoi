...
class MyStackUnitTesting {
	...
	// Test if the toString is implemented as the AbstractCollection<E> toString
	// method
	// * In this test we have created a string for what the toString() should return
	// like when
	...
	void testSize() {
		...
		myStack.push(Integer.toString(3));
		myStack.push(Integer.toString(6));
		assertEquals(3, myStack.size(), "size should be 3");
	...
	void testIsEmptyTrue() {
		...
		myStack.push(Integer.toString(6));
		myStack.clear();
		assertEquals(true, myStack.isEmpty(), "stack should be empty");
	...
	void testIsEmptyFalse() {
		...
		myStack.push(Integer.toString(3));
		myStack.push(Integer.toString(6));
		assertEquals(false, myStack.isEmpty(), "stack should not be empty");
	...
	void testGet() {
		...
		myStack.push(Integer.toString(3));
		myStack.push(Integer.toString(6));
		assertEquals("3", myStack.get(1), "should return 3 as a string");
	...
	void testContainsTrue() {
		...
		myStack.push(Integer.toString(3));
		myStack.push(Integer.toString(6));
		assertEquals(true, myStack.contains(Integer.toString(6)), "stack should contain 6 as a string");
...
//
	...
	void testContainsFalse() {
		...
		myStack.push(Integer.toString(3));
		myStack.push(Integer.toString(6));
		assertEquals(false, myStack.contains(Integer.toString(11)), "stack should not contain 11 as a string");
